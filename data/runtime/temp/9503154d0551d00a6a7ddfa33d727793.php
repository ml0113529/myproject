<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/system/web2.htm";i:1554272640;s:85:"/Users/lixiangyang/Desktop/projects/test/application/admin/template/public/layout.htm";i:1547521062;s:82:"/Users/lixiangyang/Desktop/projects/test/application/admin/template/system/bar.htm";i:1554272640;s:85:"/Users/lixiangyang/Desktop/projects/test/application/admin/template/public/footer.htm";i:1525273456;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
        ...
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="<?php echo U('System/smtp'); ?>" <?php if(preg_match('/^smtp/i', ACTION_NAME)): ?>class="current"<?php endif; ?>><span>接口配置</span></a></li>
                <?php endif; endif; ?>
            </ul>
        </div>
    </div>
    <form method="post" id="handlepost" action="<?php echo U('System/web2'); ?>" enctype="multipart/form-data" name="form1">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    http://www.iamkai.com/<input type="hidden" name="adminbasefile_old" value="<?php echo (isset($adminbasefile) && ($adminbasefile !== '')?$adminbasefile:'login'); ?>"><input id="adminbasefile" name="adminbasefile" value="<?php echo (isset($adminbasefile) && ($adminbasefile !== '')?$adminbasefile:'login'); ?>" type="text" data-site_url="http://www.iamkai.com" onKeyUp="this.value=this.value.replace(/[^0-9a-zA-Z_-]/g,'');" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^0-9a-zA-Z_-]/g,''));" style="width: 80px;" />.php
