<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/other/index.htm";i:1554272640;s:85:"/Users/lixiangyang/Desktop/projects/test/application/admin/template/public/layout.htm";i:1547521062;s:81:"/Users/lixiangyang/Desktop/projects/test/application/admin/template/other/bar.htm";i:1543507374;s:85:"/Users/lixiangyang/Desktop/projects/test/application/admin/template/public/footer.htm";i:1525273456;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table style="width: 100%;">
                    ...
                    <?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
                        <tr>
                            ...
                            <td class="w120">
                                <div class="tc">
                                    <img src="<?php echo (isset($vo['litpic']) && ($vo['litpic'] !== '')?$vo['litpic']:'/public/static/common/images/not_adv.jpg'); ?>" width="60" onmouseover="layer_tips=layer.tips('<img src=<?php echo (isset($vo['litpic']) && ($vo['litpic'] !== '')?$vo['litpic']:'/public/static/common/images/not_adv.jpg'); ?> width=150 style=\'max-height:250px;\'>',this,{tips: [1, '#fff']});" onmouseout="layer.close(layer_tips);">&nbsp;
                                </div>
                            </td>
