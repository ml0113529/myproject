...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <div class="sDiv">
                <div class="sDiv2 addartbtn fl" style="margin-right: 6px;">
                    <input type="button" class="btn current" value="邮件配置" onclick="window.location.href='<?php echo url("System/smtp"); ?>';">
                </div>
            </div>
        </div>
